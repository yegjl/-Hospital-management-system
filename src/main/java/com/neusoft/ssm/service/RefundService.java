...
public interface RefundService {
    ...
    boolean add(String medical_record_no, String expense_category, String expense_id, Long refund_number, Double refund_expense, String pay_category, String day_settle_sign, Date refund_date);
