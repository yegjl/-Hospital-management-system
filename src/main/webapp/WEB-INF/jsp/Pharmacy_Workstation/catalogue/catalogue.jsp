        ...
        <div class="layui-card layui-form" lay-filter="component-form-element">
            <div class="test-table-reload-btn" style="margin-bottom: 10px;">
                <div class="layui-input-inline" style="margin-left: 10px;">
                    <input type="text" id="demoReload" class="layui-input">
                </div>
...
<script>
    ...
    <script>
        ...
        var active = {
            ...
            // 调价
            //弹窗中的内容是adjustprice表，
            // 所以在controller里面的是传进去一个adjustprice对象，
            // 然后将drugs对象的相应属性存起来
            change: function (othis) {
                ...
                layer.open({
                    ...
                    yes: function (index,layero) {
                        var iframes = $(layero).find("iframe")[0].contentWindow;
                        var form = iframes.document.getElementById("change");
                        $.ajax({
                            type: "POST",
                            url: "drugstore/changemedicine?id="+tabledata[0].id,
                            data: $(form).serialize(),
                            success: function (res) {
                                if (res.status == 0) {
                                } else {
            ...
            table: function (othis) {
                ...
                layer.open({
                    ...
                    content: '<iframe src="drugstore/indextable?id='+tabledata[0].id+'" frameborder="0" class="layadmin-iframe"></iframe>',
                    btn: ['确定', '取消'],
                    yes: function () {
                        layer.closeAll();
                    },
