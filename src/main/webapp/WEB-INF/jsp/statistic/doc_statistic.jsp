...
<script>
    ...
    function getTitle() {
        ...
        mycols[0] = {field: 'name', title: '医生姓名', width: 150};
...
<%--                            <input class="layui-btn" type="button" value="查询" style="margin:auto;" id="search" onclick="getSelect()">--%>
        ...
        <div class="layui-col-md12">
            ...
            <div class="layui-card">
                <div class="layui-card-header" style="margin-left: 35%;font-size: 200%;margin-top: 2%">
                    门诊医生工作量统计
                </div>
