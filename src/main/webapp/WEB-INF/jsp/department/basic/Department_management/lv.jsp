            ...
            var active = {
                ...
                addTop: function(othis){
                    ...
                    layer.open({
                        ...
                        ,content: '<form id="add" style="padding: 20px;" role="form">号别编码：&nbsp;&nbsp;&nbsp;<input class="layui-input"  name="numbercode" autocomplete="off" style="width: 200px;display: inline;margin:10px;"><br>号别名称：&nbsp;&nbsp;&nbsp;<input class="layui-input"  name="numbername" autocomplete="off" style="width: 200px;display: inline;margin:10px;"><br>是否默认：&nbsp;&nbsp;&nbsp;<input class="layui-input"  name="isdefult" autocomplete="off" style="width: 200px;display: inline;margin:10px;"><br>显示顺序号：<input class="layui-input"  name="displayorder" autocomplete="off" style="width: 200px;display: inline;margin:10px;"><br>挂号费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="layui-input"  name="fee" autocomplete="off" style="width: 200px;display: inline;margin:10px;"><br></form>'
                        ,btn: ['确定','关闭']
                        ,yes: function() {
                            $.ajax({
                                type: "POST",
                                url: "registrationLevel/add",
                                data: $('#add').serialize(),
                ...
                ,edit: function(othis){
                    ...
                    var html='<form id="update" style="padding: 20px;">id：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="layui-input" name="id" id="" autocomplete="off" style="width: 200px;display: inline;margin:10px;" align="center" value="'+tabledata[0].id+'"><br>号别编码：&nbsp;&nbsp;&nbsp;<input class="layui-input" name="numbercode"  autocomplete="off" style="width: 200px;display: inline;margin:10px;" value="'+tabledata[0].numbercode+'"><br>号别名称：&nbsp;&nbsp;&nbsp;<input class="layui-input" name="numbername" autocomplete="off" style="width: 200px;display: inline;margin:10px;" value="'+tabledata[0].numbername+'"><br>是否默认：&nbsp;&nbsp;&nbsp;<input class="layui-input" name="isdefult" autocomplete="off" style="width: 200px;display: inline;margin:10px;" value="'+tabledata[0].isdefult+'"><br>显示顺序号：<input class="layui-input" name="displayorder" autocomplete="off" style="width: 200px;display: inline;margin:10px;" value="'+tabledata[0].displayorder+'"><br>挂号费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="layui-input" name="fee" autocomplete="off" style="width: 200px;display: inline;margin:10px;" value="'+tabledata[0].fee+'"><br></form>';
                    var type = othis.data('type')
                        ,text = othis.text();
                ...
                ,deltable:function(othis){
                    var type = othis.data('type')
                        ,text = othis.text();
                    var tabledata=layui.table.checkStatus('test-table-reload').data;
                    var table ="<div style='text-align: center;'> <table border='1px' style='margin: auto' cellspacing='10px' cellpadding='10px'><th>ID</th><th>号别编码</th><th>号别名称</th><th>是否默认</th><th>显示顺序号</th><th>挂号费</th>"
                    for(var i=0;i<tabledata.length;i++){
                        table+="<tr><td>"+tabledata[i].id+"</td><td>"+tabledata[i].numbercode+"</td><td>"+tabledata[i].numbername+"</td><td>"+tabledata[i].isdefult+"</td><td>"+tabledata[i].displayorder+"</td><td>"+tabledata[i].fee+"</td></tr>";
                    }
                    table+="</table> </div>";
