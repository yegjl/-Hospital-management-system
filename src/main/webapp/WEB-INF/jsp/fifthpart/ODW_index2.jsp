            ...
            <div class="layui-tab layui-tab-brief" lay-filter="component-tabs-brief">
                ...
                <div class="layui-tab-content" style="height: 100%;">
                    <div class="layui-tab-item layui-show" style="height: 100%">
                        ...
                        <iframe src="MedicalRecordPage/index" style="height: 700px;width: 100%"
                            frameborder="0"></iframe>
                    </div>
                    <div class="layui-tab-item">
                        <iframe src="inspection_application/inspection_application.html"
                            style="height: 700px;width: 100%" frameborder="0"></iframe>
                    </div>
                    <div class="layui-tab-item"> </div>
                    <div class="layui-tab-item">内容4</div>
                    <div class="layui-tab-item">内容5</div>
                    <div class="layui-tab-item"><iframe src="medicine_prescription/medicine_prescription.html"
