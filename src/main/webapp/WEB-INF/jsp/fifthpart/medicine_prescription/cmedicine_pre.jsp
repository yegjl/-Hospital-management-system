            ...
            <div class="layui-card">
                <div class="layui-card-header " style="height: 80px;">
                    ...
                    <div class="layui-card layui-form" lay-filter="component-form-element" style="width: 100%">
                        <!-- <div class="layui-col-md2" style="font-size: 200%;padding: 500;">草药处方</div> -->
                        <div class="layui-col-md2">
                            <p style="font-size: 200%;font-weight: 500;">草药处方</p>
                        </div>
        ...
        var active = {
            ...
            add: function (othis) {
                ...
                layer.open({
                    ...
                    shade: 0,
                    maxmin: true,
                    content: '<iframe src="prescribe/addcaomed?drugid=103" frameborder="0" class = "layadmin-iframe"></iframe>',
                    btn: ['确定', '全部关闭'],
                    yes: function (index, layero) {
